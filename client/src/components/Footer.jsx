                    ...
                    <div>
                        ...
                        <div className="flex space-x-4 mt-6">
                            {["twitter", "facebook", "instagram", "github"].map((icon) => (
                                <a key={icon} href="#" className="text-gray-400 hover:text-blue-500 transition duration-300 text-xl">
                    ...
                    <div>
                        ...
                        <form className="mt-4 relative">
                            <input
                                ...
                                className="w-full px-4 py-3 pr-16 rounded-md bg-gray-800 text-white border border-gray-700 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                            />
                            <button
                                type="submit"
                                className="absolute right-1 top-1 bottom-1 px-5 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-md transition duration-300"
                            >
                                →
                            </button>
                        </form>
